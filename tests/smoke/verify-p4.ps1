...
Section 'Test 4: 4 catalog entries present (offline registry writes)' 'Expected: first 3 = 0x0, AutoDownload = 0x2'
...
Cmd 'cleanup-log entries for the 4 catalog entries (first SetupComplete-time run)' {
