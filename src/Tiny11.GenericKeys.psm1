...
# Setup accepts these to proceed without activating the OS. The user
# enters their real key after install, or the system stays in
# "activation pending" state — fully functional for testing.
# Reference: Windows Server / Windows client KMS client activation keys
# documented at learn.microsoft.com.
$script:GenericKeys = @{
